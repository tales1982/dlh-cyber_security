...
# Capstone (2x05) fix: point at the mandated capstone blocklist
# (CAPSTONE_DNS_BLOCKLIST) ahead of the original 2x04 lab path, which is a
# different, unrelated file.
BLOCKLIST="${CAPSTONE_DNS_BLOCKLIST:-/home/analyst/MedDefense_Lab/dns/blocklist.txt}"
