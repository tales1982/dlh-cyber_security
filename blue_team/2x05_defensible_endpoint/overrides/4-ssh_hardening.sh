...
# removes the generic-account / service-account SSH exposure. Adapted for
# hawthorne-app-01 (2x05 capstone): the account provisioned for this host
# is "analyst", not the medadmin/sysadmin pair from the original 2x00
# billing-srv-01 exercise.
set_directive "AllowUsers" "analyst" \
